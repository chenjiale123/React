 ...
 * @param {*} params 
 */
export const getAllUser = async (params) => await http.get('/user');

/**
 * 新增用户
 * @param {*} params 
 */
export const addUser = async (params) => await http.post('/user/add', params);

/**
 * 修改用户
 * @param {*} params 
 */
export const modifyUser = async (params) => await http.post('/user/edit',params);
